...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_9194: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_9196: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1255: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_5132: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_6443: (a: number, b: number) => void;
