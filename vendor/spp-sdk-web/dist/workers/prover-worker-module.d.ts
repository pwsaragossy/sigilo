...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1461: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1522: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_5198: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1252: (a: number, b: number) => void;
